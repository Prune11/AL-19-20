...
@Configuration
public class BankApplicationRunnerConfiguration {
    ...
    public CommandLineRunner exampleCommandLineRunner(ConfigurableEnvironment environment) {
        return new BankCommandLineRunner(shell, environment);
    }

    @Bean
    public PromptProvider myPromptProvider() {
        return () -> new AttributedString("Bank-CLI:> ", AttributedStyle.DEFAULT.foreground(AttributedStyle.GREEN).bold());
    }
